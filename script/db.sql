...
COPY public.scotus_case (id, argument_date, case_title, decision_date, decision_summary_short, result, short_summary, status, term_id, important, decision_link) FROM stdin;
10	2019-11-09	Barton v. Barr	2020-04-23	Barton is not eligible for cancellation of removal because the time stop rule applies for his conviction.	5-4	To be eligible for cancellation of a removal order, a lawful permanent resident must be in the country for seven years. However, that 7 year time can be stopped if convicted of a certain types of crimes. In this case, the crime occurred before the seven years but the conviction was not until after the seven years. There was also a dispute about how the statute should be read differently for current residents and those seeking entry.	AFFIRMED	1	f	\N
1	2019-10-07	Kahler v. Kansas	2020-03-23	Understanding the difference between right and wrong is not the only way a state can craft an insanity defense bar. Kansas may choose an alternative definition.	6-3	Is a state required to adopt an insanity defense rule where the defendant understands the difference between right and wrong?	AFFIRMED	1	f	\N
13	2019-11-05	Allen v. Cooper	2020-03-23	States have sovereign immunity protection from copyright suits and congress cannot override that constitutional protection via statute.	9-0	Can an individual sue a state for copyright violation?	AFFIRMED	1	f	\N
7	2019-10-16	Kansas v. Garcia	2020-03-03	Kansas convictions can stand because the using the I9 does not expressly preempt the Kansas statute.	5-4	Can a Kansas anti-identity theft law be used to prosecute immigrants who used someone else's social security number on their I9 federal form.	REVERSED	1	f	\N
2	2019-10-07	Peter v. NantKwest Inc.	2019-12-11	The PTO cannot recover the salaries of its legal personnel under Section 145 of the Patent Act.	9-0	Can the Patent and Trademark office recover salaries of legal staff when able to get a summary dismissal of the lawsuit.	AFFIRMED	1	f	\N
11	2019-11-04	Kansas v. Glover	2020-04-04	Without any other information, learning that the registered owner of a car had their license revoked is sufficient probable cause to stop the car under the 4th amendment.	8-1	Is there sufficient probable cause to stop a vehicle if the registered owner of the vehicle had their license revoked.	REVERSED	1	t	\N
16	2019-11-12	Department of Homeland Security v. Regents of the University of California	2020-06-18	Decision by DHS to rescind DACA was arbitrary and capricious. 	5-4	Is the rescission of the DACA program by DHS justiciable, and if so, is is lawful?	REMANDED	1	t	\N
3	2019-10-07	Ramos v. Louisiana	2020-04-20	A sharply divided opinion on non-idealogical lines holds that the 14th amendment guarantees the 6th amendment right to a unanimous jury verdict applies to the states.	6-3	There is a Sixth Amendment right to a jury trial that requires  a jury to be unanimous in federal courts. Under Apodaca v. Oregon (1972, 5-4), this right does not apply to the states. That precedent is challenged in this case.	REVERSED	1	t	\N
8	2019-10-16	Rotkiske v. Klemm	2019-12-10	Fair Debt Collection Practices Act 1yr statute of limitations begins when the violation occurs, not when it is discovered	8-1	When does the Fair Debt Collection Practices Act statute of limitations of 1 year begin?	AFFIRMED	1	f	\N
9	2019-10-16	Mathena v. Malvo	2020-02-26	Case dismissed under rule 16, all parties agree to dismissal of case in light of new VA legislation.	\N	CA04 ruled that a recent decision banning life without parole sentences for juveniles should apply retroactively, a decision that contradicts a recent VA Supreme Court decision.	DISMISSED	1	f	\N
19	2019-11-13	Ritzen Group Inc. v. Jackson Masonry, LLC	2020-01-14	Once a bankruptcy court denies a motion for relief from a creditor, that is considered a final, appealable order, and the 14 day clock for filing an appeal starts.	9-0	Is a bankruptcy court denial a motion for relief from a creditor, considered a final order, thus starting a 14 day window to appeal?	AFFIRMED	1	f	\N
17	2019-11-12	Hernandez v. Mesa	2020-02-25	The Hernandez family may not sue for wrongful death as extending Bivens for cross-boarder shootings would be a violation of the separations of powers.	5-4	A border patrol officer shot and killed an unarmed 15 year old boy across the US Mexico border. At issue is whether the family can sue for damages. 	AFFIRMED	1	t	\N
...
33	2020-01-13	Lucky Brand Dungarees Inc. v. Marcel Fashion Group Inc.	2020-05-14	Because the 2005 action and the 2011 action raised different claims, the defense preclusion does not apply to defenses not used in the 2005 action.	9-0	Does defense preclusion rule apply based on Lucky Brand not raising the defense in an earlier case.	REVERSED	1	f	\N
23	2019-12-03	Atlantic Richfield Co. v. Christian	2020-04-20	Montana land owners may sue in state court as the nuisance and trespass claims are state violations and do not fall under the superfund statute.\n\nHowever, the Montana Supreme Court erred in ruling that the homeowners were not potentially responsible parties. Since the homeowners have arsenic and lead on their properties, they fall under the superfund statute, even if it is not their fault the waste is on their properties.	7-2	Liable parties are responsible for the cleanup of superfund sites. While cleanup options are under review, no potentially responsible party may take remedial action without EPA approval.\n\nMontana Supreme Court allowed a lawsuit from several landowners against the owner of a superfund site to go forward. Atlantic Richfield petitioned SCOTUS to block the lawsuit.	REMANDED	1	f	\N
28	2019-12-10	Maine Community Health Options v. United States	2020-04-27	Congress did not imply repeal of the risk corridors in the subsequent appropriation riders, and the ACA did not limit funds or specifically require appropriations for funds in the statute text. The government must pay the insurers for losses incurred in the risk corridor program.	8-1	ACA created a Risk Corridor program to pay for insurance company losses during the first few years of the program. Congress refused to appropriate funds for this. Does congress still have to pay?	REVERSED	1	t	\N
26	2019-12-09	Guerrero-Lasprilla v. Barr	2020-03-23	At issue was a question of law regarding a legal standard applied to undisputed facts, and therefore the Fifth Circuit does have jurisdiction to hear the appeal. 	7-2	When can a final deportation order be appealed where the removal rests upon the fact that the alien has committed certain crimes.	REMANDED	1	f	\N
29	2019-12-10	Holguin-Hernandez v. United States	2020-02-26	By arguing for a specific sentence (nothing or less than 12 months) the claim that the sentence imposed was unreasonably long was preserved on appeal.	9-0	Is formal objection required for appellate reasonableness review of sentence length?	REMANDED	1	f	\N
32	2019-12-11	McKinney v. Arizona	2020-02-25	Judgment below is affirmed and the death sentence for McKinney is affirmed.	5-4	Review of mitigating circumstances in the death penalty sentence.	AFFIRMED	1	f	\N
25	2019-12-04	Banister v. Davis	2020-06-01	Banister's appeal was timely as it was not a successive or second habeas petition	7-2	Rules around granting a time extension for appeals after filing a successive petition. 	REVERSED	1	f	\N
36	2020-01-14	Romag Fasteners Inc. v. Fossil Inc.	2020-04-23	It's not required to show willfulness of infringement for the disgorgement of profits. 	9-0	Can profits be collected as damages for trademark infringement when the infringement is not willful?	REVERSED	1	f	\N
34	2020-01-13	Thole v. U.S. Bank, N.A.	2020-06-01	Affirm dismissal based on lack of standing.	5-4	Can ERISA case proceed against US Bank for mismanaging pension funds. 	AFFIRMED	1	f	\N
35	2020-01-14	Kelly v. United States	2020-05-07	Closing lanes to traffic does not count as a scheme to obtain money or property under the Wire Fraud Act. The convictions under that act are reversed.	9-0	Appeal of the convictions of those involved in the Bridgegate  New Jersey scandal. 	REVERSED	1	t	\N
37	2020-01-15	Babb v. Wilkie	2020-04-06	The motivating factor standard is sufficient to show discrimination based on age, but the but for standard may be relevant for assessing damages.	8-1	When determining discrimination by age, should the motivating factor standard or the but-for cause standard be used?	REVERSED	1	t	\N
4	2019-10-08	Bostock v. Clayton County, Georgia	2020-06-15	An employer who fires an individual merely for being gay or transgender violates Title VII	6-3	Whether discrimination against an employee because of sexual orientation constitutes prohibited employment discrimination “because of... sex” within the meaning of Title VII of the Civil Rights Act 	REVERSED	1	t	\N
...
5	2019-10-08	R.G. & G.R. Harris Funeral Homes Inc. v. Equal Employment Opportunity Commission	2020-06-15	Combined with Bostock v. Clayton County, Georgia.\n\nTitle VII protection against discrimination because of sex extends to transgender individuals.	6-3	Is discrimination against a transgender person discrimination on the basis of sex as defined in Title VII of The Civil Rights Act.	AFFIRMED	1	t	\N
63	2020-10-06	Tanzin v. Tanvir	2020-12-10	The express remedies in RFRA allow someone to obtain money damages against federal officials who violate their constitutional rights. The case against the federal agents who placed muslims who refused to act as informants on the no fly list may proceed against those agents.	8-0	Does the Religious Freedom Restoration Act [RFRA] permit suits for monetary damages against individual federal employees?	AFFIRMED	2	t	\N
62	2020-10-06	Rutledge v. Pharmaceutical Care Management Association	2020-12-10	Arkansas regulation of PBMs is not preempted by ERISA or Medicare part D. The Arkansas Act 900 stands.	8-0	Arkansas regulates pharmacy benefit managers' drug-reimbursement rates, similar to other states. Is this preempted by ERISA and Medicare Part D? (SCOTUS precedent says ERISA does not preempt state regulations) 	REVERSED	2	f	\N
76	2020-11-09	Niz-Chavez v. Wilkinson	\N	\N	\N	Is the time-stop rule triggered upon the delivery of a notification if that document does not contain all required information? Can the government take as much time as it needs to deliver the missing information?	ARGUED	2	f	\N
61	2020-10-05	Texas v. New Mexico	2020-12-14	New Mexico's motion for credit was timely.\n\nNew Mexico is entitled to delivery credit for the evaporated water.	8-0	Ongoing case of original Jurisdiction\n\nDid the River Master correctly allocated evaporation losses under the Pecos River Compact?	AFFIRMED	2	f	\N
68	2020-10-14	Torres v. Madrid	2021-03-25	The application of physical force to the body of a person with intent to restrain is a seizure even if the person does not submit and is not subdued.\n\nJustice Barrett took no part in the consideration or decision of the case.	5-3	Is an unsuccessful attempt to restrain a suspect a "seizure", under the fourth amendment, or must the use of force be successful?\n\nCircuit split with 10th circuit ruling that the detention attempt must be successful (granting qualified immunity) and the 8th, 9th, and 11th circuits ruling otherwise. 	REMANDED	2	t	\N
65	2020-10-07	Ford Motor Company v. Montana Eighth Judicial District Court	2021-03-25	Specific jurisdiction is justified because Ford does significant business in the state.\n\nJustice Barrett took no part in the consideration or decision of the cases.	8-0	For product liability, can the state court exercise specific jurisdiction given a lack of forum contacts in the state?	AFFIRMED	2	f	\N
71	2020-11-02	Salinas v. United States Railroad Retirement Board	2021-02-03	"The Board’s refusal to reopen a prior benefits determination is subject to judicial review." This counts as a final decision. The RRA does not contain language that would limit the ability for courts to review final decisions, and the denial of re-opening a benefit claim is a final decision.	5-4	Do the Railroad Unemployment Insurance Act and the Railroad Retirement Act give the federal courts the ability to review denials of benefit decisions?	REMANDED	2	f	\N
75	2020-11-09	Brownback v. King	2021-02-25	The district court's ruling triggers the Judgement Bar and prohibits any other claims made based on the same injuries. This prevents the Bivens claims from being made.	9-0	Can a Bivens claim be made after a case under the Federal Torte Claims Act found the private person would not be liable in a separate case based on the same injuries?	REVERSED	2	f	\N
77	2020-11-11	California v. Texas	\N	\N	\N	Did reducing the individual mandate "tax" of the Affordable Care Act [ACA] to $0 render it unconstitutional, and if so, what parts of ACA are severable, if any?	ARGUED	2	t	\N
66	2020-10-13	United States v. Briggs	2020-12-10	The rape prosecutions were timely and not subject to the statute of limitations. 	8-0	The 5 year statute of limitations for rape in the Armed Forces was eliminated in 2006. Is a rape that occurred in 2005 and was not prosecuted until 8 years later subject to the original statute of limitations?	REVERSED	2	t	\N
79	2020-12-02	Edwards v. Vannoy	\N	\N	\N	Does the Supreme Court’s decision in Ramos v. Louisiana apply retroactively to cases on federal collateral review?	ARGUED	2	f	\N
87	2020-12-08	Henry Schein Inc. v. Archer and White Sales Inc.	2021-01-25	Dismissed without additional comment. No noted dissents or concurrences.	9-0	Does a provision in an arbitration agreement that exempts certain claims from arbitration negates an otherwise clear and unmistakable delegation of questions of arbitrability to an arbitrator.	DIG	2	f	\N
82	2020-12-01	Nestle USA, Inc. v. Doe I	\N	\N	\N	Does the judiciary has the authority under the Alien Tort Statute to impose liability on domestic corporations for wrongs that occurred extraterritoriality at the hands of unidentified foreign actors?	ARGUED	2	t	\N
89	\N	Department of Justice v. House Committee on the Judiciary	\N	\N	\N	Is an impeachment trial a "judicial proceeding" under the federal rules of criminal procedure?\n\nThis case involves the release of the grand jury materials from the Robert Mueller investigation to the House Judiciary Committee.	GRANTED	2	t	\N
81	2020-12-07	Federal Republic of Germany v. Philipp	2021-02-03	Heirs to property confiscated by the Nazis unsuccessfully tried to get their property back from Germany. Now they are trying to sue in US courts, but FSIA exceptions for violating international law do not apply in this case since international law does not cover taking of property from a countries own citizens.	9-0	Does the expropriation exception to the Foreign Sovereign Immunities Act [FSIA] apply when property confiscated in violation of human rights, even if the crime was within the borders of the same country?	REMANDED	2	f	\N
118	2021-04-21	Minerva Surgical Inc. v. Hologic Inc.	\N	\N	\N	Can a defendant in a patent infringement action who assigned the patent, or is in privity with an assignor of the patent, have a defense of invalidity heard on the merits?	ARGUED	2	f	\N
78	2020-12-09	Collins v. Mnuchin	\N	\N	\N	Is the Federal Housing Finance Agency’s [FHFA] structure, with a single director not removable except for cause, a violation of the constitution (Seila Law); should the courts set aside a final agency action that FHFA took when it was unconstitutionally structured and strike down the statutory provisions that make FHFA independent?	ARGUED	2	t	\N
93	2021-01-19	Federal Communications Commission v. Prometheus Radio Project	2021-04-01	The FCC's decision to repeal the previous ownership requirement rules was not arbitrary and capricious for the purposes of the APA. The court cannot say that the decision to repeal the ownership rules falls outside of the zone of reasonableness.	9-0	Did the appeals court error in striking down the updated FCC rules allowing for more cross-ownership in the same markets?	REVERSED	2	t	\N
95	2021-03-01	United States v. Arthrex Inc.	\N	\N	\N	Are Administrative Patent Judges [APJ] required to be nominated and approved by the senate, or are they "inferior officers" that may be appointed directly by the Secretary of Commerce?	ARGUED	2	t	\N
84	2020-11-30	Van Buren v. United States	\N	\N	\N	Does a person who is authorized to access information on a computer for certain purposes violate the Computer Fraud and Abuse Act if he accesses the same information for an improper purpose?	ARGUED	2	t	\N
99	2020-11-30	Trump v. New York	2020-12-18	Dismissed due to lack of standing. Judicial resolution of this dispute is premature.	6-3	President Trump created a memorandum instructing the Secretary of Commerce to create a list of persons from the decennial census that excludes illegal immigrants for use in congressional apportionment. Is this a permissible use of executive authority?	REMANDED	2	t	\N
91	2021-02-23	Barr v. Dai	\N	\N	\N	Can a court of appeals may conclusively presume that an asylum applicant’s testimony is credible and true whenever an immigration judge or the Board of Immigration Appeals [BIA] adjudicates an application without making an explicit adverse credibility determination?	ARGUED	2	f	\N
96	\N	Pekoske v. Innovation Law Lab	\N	\N	\N	Is the Department of Homeland Security policy known as the Migrant Protection Protocols [MPP] a lawful implementation of the statutory authority, and is the injunction against the program from the district court impermissibly broad?	GRANTED	2	t	\N
92	2021-01-19	BP P.L.C. v. Mayor and City Council of Baltimore	\N	\N	\N	Can a court of appeals review a district court's ruling remanding a case to state court?\n\nThis is a narrow jurisdictional question of a large climate change lawsuit.	ARGUED	2	f	\N
98	\N	Biden v. Sierra Club	\N	\N	\N	Did the acting secretary exceeded his statutory authority under by transferring approximately $2.5 billion in response to a request from the Department of Homeland Security for counterdrug assistance, including in the form of construction of fences along the southern border of the United States?	GRANTED	2	t	\N
97	2021-02-24	Lange v. California	\N	\N	\N	Does the pursuit of a person whom a police officer has probable cause to believe has committed a misdemeanor categorically qualifies as an exigent circumstance sufficient to allow the officer to enter a home without a warrant?	ARGUED	2	t	\N
86	2020-12-01	CIC Services, LLC v. Internal Revenue Service	\N	\N	\N	Does the Anti-Injunction Act’s [AIA] bar on lawsuits for the purpose of restraining the assessment or collection of taxes also bar challenges to unlawful regulatory mandates issued by administrative agencies that are not taxes.	ARGUED	2	f	\N
94	2021-03-02	Brnovich v. Democratic National Committee	\N	\N	\N	Does (1) Arizona's policy not to count provisional ballots cast outside of the persons precinct violate the Voting Rights Act [VRA] and (2) does the AZ law prohibiting 3rd parties from handling other persons completed ballots (anti ballot collection law) violate the VRA and the 15th amendment?	ARGUED	2	t	\N
88	2021-01-12	Uzuegbunam v. Preczewski	2021-03-08	A request for nominal damages is sufficient to preserve Article III standing to sue, even after the underlying constitutional case is rendered moot by changing the offending policy.	8-1	When the constitutional case is moot, must a suit for nominal damages be dismissed as moot as well?	REMANDED	2	f	\N
117	2021-04-27	United States v. Palomar-Santiago	\N	\N	\N	Should a charge for improper entry be dismissed solely because the original deportation would not be valid under current law, even if the defendant has not exhausted all potential administrative remedies first?	ARGUMENT_SCHEDULED	2	t	\N
107	\N	Cochran v. Gresham	\N	\N	\N	Did the DC Circuit err in ruling that the Secretary for Health and Human Services [HHS] improperly granted permission for a medicaid work requirement program in a way that was arbitrary and capricious?	GRANTED	2	t	\N
101	\N	Taylor v. Riojas	2020-11-02	The Fifth Circuit erred in granting Qualified Immunity. No reasonable officer could have concluded that such conditions were constitutionally permissible.\n\nJustice Barrett took no part in the consideration or decision of this case.	7-1	Is keeping a prisoner in a cell covered in feces an unconstitutional violation of the eight amendment and can the corrections officers be protected from damages under qualified immunity?	GVR	2	t	\N
100	\N	Mckesson v. Doe	2020-11-02	Remanded to the lower court to get input on the relevant LA state law from the state supreme court. There is an underlying first amendment constitutional question, but this court only needs to consider that question if the case is allowed to proceed under LA law.\n\nJustice Barrett took no part in the consideration or decision of this case.	7-1	An anonymous police officer (Officer Doe) was hit with a brick during a Black Lives Matter [BLM] protest in Louisiana. DeRay Mckesson organized the protest, but was not responsible for the violence. Can Officer Doe sue Mckesson for damages on the theory that he negligently staged the protest?	GVR	2	t	\N
73	2020-11-03	Borden v. United States	\N	\N	\N	Does the "use of force" clause in the Armed Career Criminal Act [ACCA] encompasses crimes with a mens rea or mere "recklessness" standard?	ARGUED	2	f	\N
74	2020-11-04	Fulton v. City of Philadelphia, Pennsylvania	\N	\N	\N	Philadelphia barred Catholic Social Services [CSS] from adoption referrals after it refused to allow adoptions to LGBTQ parents in violation of the city's anti-discrimination act. \n1) Must a free exercise claim show that the government would allow the same behavior from a different religious group (neutrality)? This is a circuit split.\n2) Should SCOTUS revisit Employment Division v. Smith? This case from 1990 says that while states can make accommodations for otherwise illegal activity performed for religious reasons, they are not required to do so.\n3) Does the government violate the first amendment by forcing an agency to violate its religious beliefs in order to participate in the foster care system?	ARGUED	2	t	\N
106	\N	Roman Catholic Diocese of Brooklyn, New York v. Cuomo	2020-11-25	Preliminary injunction is granted. New York may not enforce the 10-25 person restriction on religious services pending a decision in the second court of appeals. "Should the petition for a writ of certiorari be denied, this order shall terminate automatically."	5-4	Application for a preliminary injunction against an executive order from New York limiting attendance to religious services in areas with a high rate of COVID-19 spread.\n\nShould the court enjoin the executive order and prevent its enforcement pending the outcome of litigation in the lower courts? Additionally, did the court err in requiring deference to state executives and health departments during the pandemic?	GVR	2	t	\N
110	2021-02-22	Florida v. Georgia	2021-04-01	Florida's exceptions to the Special Master's Report are overruled, and the case is dismissed.	9-0	Case of Original Jurisdiction. Dispute over a remedial decree equitably apportioning the water from an interstate river basin.	AFFIRMED	2	f	\N
112	2021-04-20	Greer v. United States	\N	\N	\N	Can a circuit court of appeals may review matters outside the trial record to determine whether the error affected a defendant’s substantial rights or impacted the fairness, integrity or public reputation of the trial.	ARGUED	2	f	\N
116	2021-04-26	Guam v. United States	\N	\N	\N	Can an environmental settlement not under The Comprehensive Environmental Response, Compensation, and Liability Act [CERCLA] that expressly disclaims any liability determination and leaves the settling party exposed to future liability trigger a contribution claim under CERCLA?	ARGUED	2	t	\N
104	2021-03-23	United States v. Cooley	\N	\N	\N	A non-native was stopped by a tribal police officer on a public road. After acting suspicious, the officer ordered him out of the car and conducted a search that revealed drugs. Does the officer have sufficient authority to conduct this arrest of a non-native absent a clear violation of law?	ARGUED	2	t	\N
109	2021-03-31	National Collegiate Athletic Association v. Alston	\N	\N	\N	Do NCAA rules that limit educational benefits to student athletes violate anti trust law?\n\nThis is a circuit split, with the 9th circuit finding an anti-trust violation differing from multiple other circuits.	ARGUED	2	t	\N
114	2021-04-19	Sanchez v. Mayorkas	\N	\N	\N	Does a TPS grant make immigrants eligible to apply for lawful permanent residence status?	ARGUED	2	t	\N
111	2021-04-26	Americans for Prosperity Foundation v. Becerra	\N	\N	\N	California requires certain organizations to disclose membership information. Should strict scrutiny or exacting scrutiny be applied when determining if this disclosure violates members freedom of association rights?	ARGUED	2	t	\N
115	2021-04-21	City of San Antonio, Texas v. Hotels.com, L.P.	\N	\N	\N	Do district courts lack the discretion to deny or reduce appellate costs that are deemed "taxable".	ARGUED	2	f	\N
108	2021-03-30	TransUnion LLC v. Ramirez	\N	\N	\N	TransUnion mistakenly matched individuals on the OFAC terrorist watch list. 8,184 individuals were identified as being wrongly matched. Ramirez personally requested a credit report and consulted a lawyer, as well as cancelling an international vacation due to concerns of being on a watch list.\n\nDid all members of the class action suffer injury sufficient to give article III standing, and does the injury apply if significantly different than the named plaintiff?	ARGUED	2	f	\N
113	2021-04-28	Mahanoy Area School District v. B.L.	\N	\N	\N	Can public school officials regulate speech that occurs off campus if that speech would materially and substantially disrupt the work and discipline of the school?\n\nThis case looks at the limits of  Tinker v. Des Moines Independent Community School District for speech that occurs off campus, outside of school hours, and does not use school resources.	ARGUMENT_SCHEDULED	2	t	\N
85	2021-01-11	Albence v. Guzman Chavez	\N	\N	\N	Is an alien who is subject to a reinstated removal order and who is pursuing withholding or deferral of removal due to fear of being tortured eligible for an individual bond hearing. 	ARGUED	2	t	\N
