...
.curl request
include::{snippets}/case/admin/term/curl-request.adoc[]

.request
include::{snippets}/case/admin/term/http-request.adoc[]

.request fields
include::{snippets}/case/admin/term/request-fields.adoc[]

.response fields
include::{snippets}/case/admin/term/response-fields.adoc[]

.response body
include::{snippets}/case/admin/term/response-body.adoc[]
...
.curl request
include::{snippets}/case/admin/editTerm/curl-request.adoc[]

.request
include::{snippets}/case/admin/editTerm/http-request.adoc[]

.path parameters
include::{snippets}/case/admin/editTerm/path-parameters.adoc[]

.request fields
include::{snippets}/case/admin/editTerm/request-fields.adoc[]

.response fields
include::{snippets}/case/admin/editTerm/response-fields.adoc[]

.response body
include::{snippets}/case/admin/editTerm/response-body.adoc[]
