...
class TagNotFoundException(id: Long): ObjectNotFoundException(id, "Tag")

// Exception handler will return 400 for these errors
...
class NoTermIdException(id: Long): NoEntityIdException(id, "Term")
class NoTagIdException(id: Long): NoEntityIdException(id, "Tag")